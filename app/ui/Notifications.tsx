...
import { IMakeNotification, IUserWithAvatar } from '../../lib/types';
import { getCssValue, getUrl, isTabActive, useContext, useSetGlobalState } from '../lib/utils';
...
export const messageNotification = (sender: IUserWithAvatar) => () =>
  (
    <div className="flex items-center">
      <img src={sender.avatar.path} width={50} height={50} alt="" />
